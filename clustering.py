...
class ReassignedDataset(data.Dataset):
    ...
    def __init__(self, image_indexes, pseudolabels, dataset, transform=None):
        self.image_list = self.make_dataset(image_indexes, pseudolabels, dataset)
    ...
    def __getitem__(self, index):
        ...
        """
        path, pseudolabel = self.image_list[index]
        img = pil_loader(path)
...
def cluster_assign(images_lists, dataset):
    ...
    t = transforms.Compose([transforms.Resize((cfg["input_size"], cfg["input_size"])),
